...
public class GUI extends JPanel
{
    ...
    {
        JFrame jfrm = new JFrame("1XBet");
        jfrm.setSize(400, 200);
        jfrm.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        jfrm.setVisible(true);

        JButton button1 = new JButton("CSKA");
        button1.setBackground(Color.BLUE);
        button1.setForeground(Color.WHITE);
        JButton button2 = new JButton("Spartak");
        ...
        MouseListener mouseListener = new MouseListener()
        {
            ...
            public void mouseClicked(MouseEvent e)
            {
                ...
                jlab2.setText("Last Scorer: CSKA");
                if(x > y) jlab3.setText("Winner: CSKA");
                else if(y > x) jlab3.setText("Winner: Spartak");
        ...
        MouseListener mouseListener2 = new MouseListener()
        {
            ...
            public void mouseClicked(MouseEvent e)
            {
                y++;
                jlab1.setText("Result: " + x + " x " + y);
                jlab2.setText("Last Scorer: Spartak");
                if (x > y) jlab3.setText("Winner: CSKA");
                else if (y > x) jlab3.setText("Winner: Spartak");
                else jlab3.setText("Winner: DRAW");
            }
